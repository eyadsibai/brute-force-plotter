...
class TestSingleNumericPlot:
    ...
    def test_creates_histogram_and_violin_plot(
    ...
    @pytest.mark.unit
    @pytest.mark.plotting
    def test_handles_missing_values_in_numeric(
        self, temp_dir, sample_data_with_missing
    ):
...
class TestSingleCategoryPlot:
    ...
    @pytest.mark.unit
    @pytest.mark.plotting
    def test_ignores_columns_with_many_categories(
        self, temp_dir, sample_data_many_categories
    ):
...
class TestCategoryCategoryPlot:
    ...
    def test_creates_bar_and_heatmap(self, temp_dir, sample_parquet_file):
        ...
        plot_category_category_sync(
            sample_parquet_file, "gender", "education", temp_dir
        )
...
class TestCorrelationMatrix:
    ...
    @pytest.mark.unit
    def test_skips_when_insufficient_numeric_columns(
...
class TestPlotHelperFunctions:
    ...
    def test_bar_box_violin_dot_plots(self, temp_dir, sample_mixed_data):
        ...
        bar_box_violin_dot_plots(
            sample_mixed_data, "gender", "age", axes, file_name=file_path
        )

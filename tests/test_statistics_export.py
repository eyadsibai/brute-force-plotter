...
class TestExportStatisticalSummaries:
    ...
    @pytest.mark.unit
    def test_creates_statistics_directory(self, temp_dir, sample_parquet_file, mixed_dtypes):
    ...
    @pytest.mark.unit
    def test_exports_numeric_statistics(self, temp_dir, sample_parquet_file, mixed_dtypes):
    ...
    @pytest.mark.unit
    def test_exports_categorical_statistics(self, temp_dir, sample_parquet_file, mixed_dtypes):
        ...
        education_file = os.path.join(temp_dir, "statistics", "category_education_counts.csv")
        assert os.path.exists(education_file)

    @pytest.mark.unit
    def test_exports_missing_values_summary(self, temp_dir, sample_parquet_file, mixed_dtypes):
        """Test that missing values summary is exported."""
        export_statistical_summaries(sample_parquet_file, mixed_dtypes, temp_dir)
        
        missing_file = os.path.join(temp_dir, "statistics", "missing_values_summary.csv")
    ...
    def test_handles_empty_dtypes(self, temp_dir, sample_parquet_file):
        ...
        # Statistics directory should still be created
        stats_dir = os.path.join(temp_dir, "statistics")
        # But it might be empty or minimal
